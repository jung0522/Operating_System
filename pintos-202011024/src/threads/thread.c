...
/* List to manage Blocked threads */
static struct list sleep_list;

/*store mininum value of wakeup_tick waiting in sleep_list*/
...
{
  next_wakeup_tick = MIN(next_wakeup_tick, ticks);
}
